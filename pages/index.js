...
const s = {
  ...
  topBar: { display: 'flex', justifyContent: 'space-between', padding: '14px 48px 14px 32px', borderBottom: '1px solid #e0dbd4', fontSize: '15px', letterSpacing: '0.25em', fontWeight: '300', color: '#666' },
  ...
  introLabel: { fontSize: '15px', letterSpacing: '0.3em', fontWeight: '400', color: '#777', marginBottom: '24px' },
  introText: { fontSize: '15px', fontWeight: '200', lineHeight: '2', color: '#222', letterSpacing: '0.08em', marginBottom: '32px' },
  introCredit: { fontSize: '15px', letterSpacing: '0.3em', fontWeight: '300', color: '#777' },
  rule: { height: '1px', background: '#e0dbd4', margin: '0 32px' },
  indexSection: { flex: 1, padding: '40px 48px 40px 32px' },
  indexLabel: { fontSize: '15px', letterSpacing: '0.3em', fontWeight: '400', color: '#555', marginBottom: '24px' },
  ...
  rowNum: { fontSize: '15px', letterSpacing: '0.2em', color: '#666', fontWeight: '300' },
  rowTitle: { fontSize: '15px', fontWeight: '400', letterSpacing: '0.2em', color: '#111' },
  rowDots: { borderBottom: '1px dotted #ccc', height: '1px', alignSelf: 'center', minWidth: '40px' },
  rowDesc: { fontSize: '15px', fontWeight: '200', color: '#555', lineHeight: '1.6', letterSpacing: '0.05em', textAlign: 'right' },
  footer: { padding: '16px 48px 16px 32px', borderTop: '1px solid #e0dbd4', marginTop: 'auto' },
  footerText: { fontSize: '15px', letterSpacing: '0.2em', color: '#666', fontWeight: '200' },
}
